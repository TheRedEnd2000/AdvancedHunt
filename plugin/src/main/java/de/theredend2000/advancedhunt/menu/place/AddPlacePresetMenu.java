 ...
 */
public class AddPlacePresetMenu extends SingleItemInputMenu {
    ...
    protected String getGuiKeyBase() {
        return "gui.place_presets.add";
    }

    @Override
    protected String getNoItemErrorKey() {
        return "error.place_presets.no_item";
    }
    ...
    protected String getInvalidItemErrorKey() {
        return "error.place_presets.not_a_block";
    }
