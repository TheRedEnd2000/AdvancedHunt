...
public class EggManager_1_16_R1 implements EggManager {
    ...
    public void saveFoundEggs(Player player, Block block, String id){
        Main.getInstance().getConfig().set("Eggs."+id+".TimesFound", Main.getInstance().getConfig().contains("Eggs."+id+".TimesFound") ? Main.getInstance().getConfig().getInt("Eggs."+id+".TimesFound")+1 : 1);
    ...
    public int getTimesFound(String id) {
        return Main.getInstance().getConfig().contains("Eggs."+id+".TimesFound") ? Main.getInstance().getConfig().getInt("Eggs."+id+".TimesFound") : 0;
    }
