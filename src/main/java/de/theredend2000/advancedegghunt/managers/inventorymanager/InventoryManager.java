...
public class InventoryManager {
    ...
    public void createEggsSettingsInventory(Player player) {
        ...
        inventory.setItem(10, new ItemBuilder(XMaterial.GOLD_INGOT).setDisplayname("§3One egg found reward").setLore("§7If this function is activated", "§7all commands entered in the config are executed.", "", Main.getInstance().getConfig().getBoolean("Settings.PlayerFoundOneEggRewards") ? "§a§l✔ Enabled" : "§c§l❌ Disabled", "§eClick to toggle.").setLocalizedName("settings.foundoneegg").withGlow(Main.getInstance().getConfig().getBoolean("Settings.PlayerFoundOneEggRewards")).build());
        inventory.setItem(11, new ItemBuilder(XMaterial.EMERALD).setDisplayname("§3All eggs found reward").setLore("§7If this function is activated", "§7all commands entered in the config are executed.", "", Main.getInstance().getConfig().getBoolean("Settings.PlayerFoundAllEggsReward") ? "§a§l✔ Enabled" : "§c§l❌ Disabled", "§eClick to toggle.").setLocalizedName("settings.foundalleggs").withGlow(Main.getInstance().getConfig().getBoolean("Settings.PlayerFoundAllEggsReward")).build());
        inventory.setItem(12, new ItemBuilder(XMaterial.CLOCK).setDisplayname("§3Updater").setLore("§7If this function is activated", "§7all operators will get an information", "§7if a new plugin version is out.", "", Main.getInstance().getConfig().getBoolean("Settings.Updater") ? "§a§l✔ Enabled" : "§c§l❌ Disabled", "§eClick to toggle.").setLocalizedName("settings.updater").withGlow(Main.getInstance().getConfig().getBoolean("Settings.Updater")).build());
        inventory.setItem(13, new ItemBuilder(XMaterial.COMMAND_BLOCK).setDisplayname("§3Command feedback").setLore("§7If this function is activated", "§7no more commands are sent", "§7to the operators listed in the console.", "", Main.getInstance().getConfig().getBoolean("Settings.DisableCommandFeedback") ? "§a§l✔ Enabled" : "§c§l❌ Disabled", "§eClick to toggle.").setLocalizedName("settings.commandfeedback").withGlow(Main.getInstance().getConfig().getBoolean("Settings.DisableCommandFeedback")).build());
        ...
        inventory.setItem(20, new ItemBuilder(XMaterial.NAME_TAG).setDisplayname("§3Show plugin prefix").setLore("§7If enabled the plugin prefix", "§7will show on each message.", "§cThis will effect every message in the messages.yml file.", "", Main.getInstance().getConfig().getBoolean("Settings.PluginPrefixEnabled") ? "§a§l✔ Enabled" : "§c§l❌ Disabled", "§eClick to toggle.").setLocalizedName("settings.pluginprefix").withGlow(Main.getInstance().getConfig().getBoolean("Settings.PluginPrefixEnabled")).build());
        inventory.setItem(21, new ItemBuilder(XMaterial.FIREWORK_ROCKET).setDisplayname("§3Firework").setLore("§7If this function is activated", "§7a firework will spawn if an egg is found.", "", Main.getInstance().getConfig().getBoolean("Settings.ShowFireworkAfterEggFound") ? "§a§l✔ Enabled" : "§c§l❌ Disabled", "§eClick to toggle.").setLocalizedName("settings.firework").withGlow(Main.getInstance().getConfig().getBoolean("Settings.ShowFireworkAfterEggFound")).build());
