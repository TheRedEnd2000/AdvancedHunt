...
public class ResetInventoryManager {
    ...
    public void createSelectInventory(Player player, String collection) {
        ...
        inventory.setItem(4, new ItemBuilder(XMaterial.PLAYER_HEAD).setSkullOwner(plugin.getEggManager().getRandomEggTexture(new Random().nextInt(7))).setDisplayname("§6" + collection).build());
