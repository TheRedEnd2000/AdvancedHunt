...
public class InventoryRequirementsManager {
    ...
    public void createSelectInventory(Player player, String collection) {
        ...
        inventory.setItem(10, new ItemBuilder(XMaterial.CLOCK).setDisplayname("§6Selection - Hours").setLore("§7Active: §b" + Main.getInstance().getRequirementsManager().getActives(Requirements.Hours, collection), "", "§eClick to open.").build());
        inventory.setItem(11, new ItemBuilder(XMaterial.CLOCK).setDisplayname("§6Selection - Date").setLore("§7Active: §b" + Main.getInstance().getRequirementsManager().getActives(Requirements.Date, collection), "", "§eClick to open.").build());
        inventory.setItem(12, new ItemBuilder(XMaterial.CLOCK).setDisplayname("§6Selection - Weekday").setLore("§7Active: §b" + Main.getInstance().getRequirementsManager().getActives(Requirements.Weekday, collection), "", "§eClick to open.").build());
        inventory.setItem(13, new ItemBuilder(XMaterial.CLOCK).setDisplayname("§6Selection - Month").setLore("§7Active: §b" + Main.getInstance().getRequirementsManager().getActives(Requirements.Month, collection), "", "§eClick to open.").build());
        inventory.setItem(14, new ItemBuilder(XMaterial.CLOCK).setDisplayname("§6Selection - Year").setLore("§7Active: §b" + Main.getInstance().getRequirementsManager().getActives(Requirements.Year, collection), "", "§eClick to open.").build());
        inventory.setItem(15, new ItemBuilder(XMaterial.CLOCK).setDisplayname("§6Selection - Season").setLore("§7Active: §b" + Main.getInstance().getRequirementsManager().getActives(Requirements.Season, collection), "", "§eClick to open.").build());
    ...
    public void createHourInventory(Player player, String collection) {
    ...
    public void createWeekdayInventory(Player player, String collection) {
    ...
    public void createMonthInventory(Player player, String collection) {
    ...
    public void createYearInventory(Player player, String collection) {
    ...
    public void createSeasonInventory(Player player, String collection) {
