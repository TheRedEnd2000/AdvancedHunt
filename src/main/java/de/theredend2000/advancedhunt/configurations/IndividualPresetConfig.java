...
public class IndividualPresetConfig extends MultiFileConfiguration {
    ...
    public void addDefaultRewardCommands(String preset) {
        set(preset, "Commands.0.command", "tellraw %PLAYER% \"%PREFIX%&aYou found an "+Main.getInstance().getPluginConfig().getPluginNameSingular()+". &7(&e%TREASURES_FOUND%&7/&e%TREASURES_MAX%&7)\"");
