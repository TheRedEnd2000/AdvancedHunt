...
public class LeaderboardMenu extends PagedMenu {
    ...
    public void setMenuItems() {
        ...
        addStaticItem(8,new ItemBuilder(XMaterial.PLAYER_HEAD.get())
    ...
    private void addYourRankIndicator() {
        ...
        if (playerScore == 0 || playerRank == -1) {
            ...
            indicatorItem = new ItemBuilder(XMaterial.RED_STAINED_GLASS_PANE.get())
            ...
            indicatorItem = new ItemBuilder(XMaterial.LIME_STAINED_GLASS_PANE.get())
