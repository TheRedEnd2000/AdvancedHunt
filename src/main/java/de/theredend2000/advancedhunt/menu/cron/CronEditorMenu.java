...
public class CronEditorMenu extends Menu {
    ...
    public void setMenuItems() {
        ...
        addStaticItem(4, new ItemBuilder(XMaterial.CLOCK.get())
        ...
        addButton(11, new ItemBuilder(XMaterial.SUNFLOWER.get())
        ...
        addButton(12, new ItemBuilder(XMaterial.PAPER.get())
        ...
        addButton(13, new ItemBuilder(XMaterial.WRITABLE_BOOK.get())
        ...
        addButton(14, new ItemBuilder(XMaterial.EXPERIENCE_BOTTLE.get())
        ...
        // More Presets Button
        addButton(15, new ItemBuilder(XMaterial.BOOKSHELF.get())
        ...
        addButton(20, new ItemBuilder(XMaterial.REDSTONE.get())
        ...
        addButton(21, new ItemBuilder(XMaterial.PAPER.get())
        ...
        // Clear Button
        addButton(35, new ItemBuilder(XMaterial.BARRIER.get())
